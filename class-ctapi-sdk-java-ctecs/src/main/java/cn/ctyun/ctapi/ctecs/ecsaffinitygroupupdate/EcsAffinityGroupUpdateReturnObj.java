 ...
 * Entity: EcsAffinityGroupUpdateReturnObj
 */
public class EcsAffinityGroupUpdateReturnObj {
    /**
     * affinityGroupID
     ...
     * @return this
     */
    public EcsAffinityGroupUpdateReturnObj withAffinityGroupID(String affinityGroupID) {
