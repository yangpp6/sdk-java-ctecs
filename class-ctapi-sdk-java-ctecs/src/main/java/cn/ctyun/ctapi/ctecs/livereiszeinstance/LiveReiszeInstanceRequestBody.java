...
/**
 * <云主机热变配>
 * Entity: LiveReiszeInstanceRequestBody
 */
public class LiveReiszeInstanceRequestBody {
    /**
     * regionID
    ...
    /**
     * flavorID
     * 云主机规格ID，您可以查看<a href="https://www.ctyun.cn/document/10026730/10118193">规格说明</a>了解弹性云主机的选型基本信息<br />获取：<br /><span style="background-color: rgb(73, 204, 144);color: rgb(255,255,255);padding: 2px; margin:2px">查</span> <a  href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=13078&data=87">查询云主机支持的热变配规格信息</a>
     */
     ...
     * @return this
     */
    public LiveReiszeInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public LiveReiszeInstanceRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public LiveReiszeInstanceRequestBody withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public LiveReiszeInstanceRequestBody withClientToken(String clientToken) {
     ...
     * @return this
     */
    public LiveReiszeInstanceRequestBody withPayVoucherPrice(Float payVoucherPrice) {
