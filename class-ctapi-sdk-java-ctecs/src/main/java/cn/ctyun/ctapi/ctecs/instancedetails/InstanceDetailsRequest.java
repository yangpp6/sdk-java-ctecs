 ...
 * Request: InstanceDetailsRequest
 */
public class InstanceDetailsRequest extends CTRequest {
    public InstanceDetailsRequest() {
        super("GET", "application/json", "/v4/ecs/instance-details");
    }
     ...
     * @return this
     */
    public InstanceDetailsRequest withRegionID(String regionID) {
     ...
     * @return this
     */
    public InstanceDetailsRequest withInstanceID(String instanceID) {
