 ...
 * Entity: ListInstanceByFlavorFamiliesFlavor
 */
public class ListInstanceByFlavorFamiliesFlavor {
    /**
     * flavorID
     * 规格ID
     */
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withFlavorName(String flavorName) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withFlavorCPU(Integer flavorCPU) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withFlavorRAM(Integer flavorRAM) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withGpuType(String gpuType) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withGpuCount(Integer gpuCount) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withGpuVendor(String gpuVendor) {
     ...
     * @return this
     */
    public ListInstanceByFlavorFamiliesFlavor withVideoMemSize(Integer videoMemSize) {
