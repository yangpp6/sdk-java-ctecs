 ...
 * Entity: MetadataDetailsRequestBody
 */
public class MetadataDetailsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public MetadataDetailsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public MetadataDetailsRequestBody withInstanceID(String instanceID) {
    ...
    /**
     * set metadataKey
     * @param metadataKey 元数据的键。缺省为查询云主机所有的元数据信息
     * @return this
     */
    public MetadataDetailsRequestBody withMetadataKey(String metadataKey) {
