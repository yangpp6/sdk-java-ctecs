 ...
 * Entity: AffinityGroupBindVmCheckRequestBody
 */
public class AffinityGroupBindVmCheckRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public AffinityGroupBindVmCheckRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public AffinityGroupBindVmCheckRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public AffinityGroupBindVmCheckRequestBody withAffinityGroupID(String affinityGroupID) {
