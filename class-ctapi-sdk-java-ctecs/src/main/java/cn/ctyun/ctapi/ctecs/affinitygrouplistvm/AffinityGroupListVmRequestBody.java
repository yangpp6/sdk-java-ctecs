 ...
 * Entity: AffinityGroupListVmRequestBody
 */
public class AffinityGroupListVmRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public AffinityGroupListVmRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public AffinityGroupListVmRequestBody withAffinityGroupID(String affinityGroupID) {
     ...
     * @return this
     */
    public AffinityGroupListVmRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public AffinityGroupListVmRequestBody withPageSize(Integer pageSize) {
