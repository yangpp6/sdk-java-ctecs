 ...
 * Entity: EcsStartRequestBody
 */
public class EcsStartRequestBody {
    /**
     * regionID
     * 资源池ID
     */
     ...
     * @return this
     */
    public EcsStartRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsStartRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public EcsStartRequestBody withID(String ID) {
        this.ID = ID;
        return this;
    }
