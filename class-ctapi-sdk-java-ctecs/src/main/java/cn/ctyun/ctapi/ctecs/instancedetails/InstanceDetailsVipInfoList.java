 ...
 * Entity: InstanceDetailsVipInfoList
 */
public class InstanceDetailsVipInfoList {
    /**
     * vipID
     * 虚拟IP的ID
     */
     ...
     * @return this
     */
    public InstanceDetailsVipInfoList withVipID(String vipID) {
        this.vipID = vipID;
        return this;
    }
     ...
     * @return this
     */
    public InstanceDetailsVipInfoList withVipAddress(String vipAddress) {
     ...
     * @return this
     */
    public InstanceDetailsVipInfoList withVipBindNicIP(String vipBindNicIP) {
     ...
     * @return this
     */
    public InstanceDetailsVipInfoList withVipBindNicIPv6(String vipBindNicIPv6) {
     ...
     * @return this
     */
    public InstanceDetailsVipInfoList withNicID(String nicID) {
        this.nicID = nicID;
        return this;
    }
