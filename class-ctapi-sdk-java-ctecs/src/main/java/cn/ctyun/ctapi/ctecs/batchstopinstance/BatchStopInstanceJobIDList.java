 ...
 * Entity: BatchStopInstanceJobIDList
 */
public class BatchStopInstanceJobIDList {
    /**
     * jobID
     ...
     * @return this
     */
    public BatchStopInstanceJobIDList withJobID(String jobID) {
        this.jobID = jobID;
        return this;
    }
     ...
     * @return this
     */
    public BatchStopInstanceJobIDList withInstanceID(String instanceID) {
