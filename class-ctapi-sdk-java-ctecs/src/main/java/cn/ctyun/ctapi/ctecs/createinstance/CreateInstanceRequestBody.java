...
/**
 * <一类节点-*-云主机ctecs-创建云主机>
 * Entity: CreateInstanceRequestBody
 */
public class CreateInstanceRequestBody {
     ...
     */
    private CreateInstanceNetworkCardList[] networkCardList;
    /**
     * extIP
     ...
     */
    private CreateInstanceDataDiskList[] dataDiskList;
    /**
     * ipVersion
     ...
     */
    private CreateInstanceLabelList[] labelList;
    /**
     * gpuDriverKits
     ...
     * @return this
     */
    public CreateInstanceRequestBody withClientToken(String clientToken) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public CreateInstanceRequestBody withDisplayName(String displayName) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withImageType(Integer imageType) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withImageID(String imageID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withBootDiskType(String bootDiskType) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withBootDiskSize(Integer bootDiskSize) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withOnDemand(Boolean onDemand) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withNetworkCardList(CreateInstanceNetworkCardList[] networkCardList) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withExtIP(String extIP) {
        this.extIP = extIP;
        return this;
    }
     ...
     * @return this
     */
    public CreateInstanceRequestBody withSecGroupList(String[] secGroupList) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withDataDiskList(CreateInstanceDataDiskList[] dataDiskList) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withIpVersion(String ipVersion) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withBandwidth(Integer bandwidth) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withIpv6AddressID(String ipv6AddressID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withEipID(String eipID) {
        this.eipID = eipID;
        return this;
    }
     ...
     * @return this
     */
    public CreateInstanceRequestBody withAffinityGroupID(String affinityGroupID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withKeyPairID(String keyPairID) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withUserPassword(String userPassword) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withCycleCount(Integer cycleCount) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withCycleType(String cycleType) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withAutoRenewStatus(Integer autoRenewStatus) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withPayVoucherPrice(Float payVoucherPrice) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withLabelList(CreateInstanceLabelList[] labelList) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withGpuDriverKits(String gpuDriverKits) {
     ...
     * @return this
     */
    public CreateInstanceRequestBody withMonitorService(Boolean monitorService) {
    ...
    public CreateInstanceNetworkCardList[] getNetworkCardList() {
        return networkCardList;
    }

    public void setNetworkCardList(CreateInstanceNetworkCardList[] networkCardList) {
        this.networkCardList = networkCardList;
    }
    ...
    public CreateInstanceDataDiskList[] getDataDiskList() {
        return dataDiskList;
    }

    public void setDataDiskList(CreateInstanceDataDiskList[] dataDiskList) {
        this.dataDiskList = dataDiskList;
    }
    ...
    public CreateInstanceLabelList[] getLabelList() {
        return labelList;
    }

    public void setLabelList(CreateInstanceLabelList[] labelList) {
        this.labelList = labelList;
    }
