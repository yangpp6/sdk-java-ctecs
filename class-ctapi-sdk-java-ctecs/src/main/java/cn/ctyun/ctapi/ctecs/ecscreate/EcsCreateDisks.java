 ...
 * Entity: EcsCreateDisks
 */
public class EcsCreateDisks {
    /**
     * diskMode
     ...
     * @return this
     */
    public EcsCreateDisks withDiskMode(String diskMode) {
    ...
    /**
     * set title
     * @param title 云硬盘名称，长度2~63,不支持中文
     * @return this
     */
    public EcsCreateDisks withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateDisks withType(String type) {
        this.type = type;
        return this;
    }
    ...
    /**
     * set size
     * @param size 云硬盘容量大小单位为GiB，取值范围:[10-32768]
     * @return this
     */
    public EcsCreateDisks withSize(Integer size) {
        this.size = size;
        return this;
    }
