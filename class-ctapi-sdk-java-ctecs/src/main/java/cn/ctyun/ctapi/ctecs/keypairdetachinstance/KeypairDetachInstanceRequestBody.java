 ...
 * Entity: KeypairDetachInstanceRequestBody
 */
public class KeypairDetachInstanceRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public KeypairDetachInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public KeypairDetachInstanceRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public KeypairDetachInstanceRequestBody withKeyPairName(String keyPairName) {
