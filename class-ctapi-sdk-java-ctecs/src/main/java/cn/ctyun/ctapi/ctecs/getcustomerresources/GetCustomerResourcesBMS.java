 ...
 * Entity: GetCustomerResourcesBMS
 */
public class GetCustomerResourcesBMS {
    /**
     * total_count
     * 物理机总数
     */
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withTotal_count(Integer total_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withDetail_total_count(Integer detail_total_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withMemory_count(Integer memory_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withCpu_count(Integer cpu_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withBm_shutd_count(Integer bm_shutd_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withExpire_running_count(Integer expire_running_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withBm_running_count(Integer bm_running_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withExpire_count(Integer expire_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesBMS withExpire_shutd_count(Integer expire_shutd_count) {
