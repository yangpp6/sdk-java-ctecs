 ...
 * Entity: EcsBackupRestoreRequestBody
 */
public class EcsBackupRestoreRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsBackupRestoreRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsBackupRestoreRequestBody withInstanceBackupID(String instanceBackupID) {
