...
/**
 * <轻量型云主机重启>
 * Entity: EcsLiteRebootRequestBody
 */
public class EcsLiteRebootRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsLiteRebootRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsLiteRebootRequestBody withInstanceID(String instanceID) {
