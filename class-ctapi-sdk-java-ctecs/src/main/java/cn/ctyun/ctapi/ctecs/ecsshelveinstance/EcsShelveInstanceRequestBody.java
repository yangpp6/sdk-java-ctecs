 ...
 * Entity: EcsShelveInstanceRequestBody
 */
public class EcsShelveInstanceRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsShelveInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsShelveInstanceRequestBody withInstanceID(String instanceID) {
