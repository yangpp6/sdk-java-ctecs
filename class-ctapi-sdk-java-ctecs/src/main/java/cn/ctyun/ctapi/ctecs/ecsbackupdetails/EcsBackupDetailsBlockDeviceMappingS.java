 ...
 * Entity: EcsBackupDetailsBlockDeviceMappingS
 */
public class EcsBackupDetailsBlockDeviceMappingS {
    /**
     * backup_id
     * 云硬盘备份ID
     */
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withBackup_id(String backup_id) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withVolume_id(String volume_id) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withBoot_volume(Boolean boot_volume) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withMount_device(String mount_device) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withVolume_size(String volume_size) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withVolume_type(String volume_type) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withDelete_on_termination(Boolean delete_on_termination) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withBoot_index(Integer boot_index) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withDevice_name(String device_name) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withContainer(String container) {
     ...
     * @return this
     */
    public EcsBackupDetailsBlockDeviceMappingS withService_metadata(String service_metadata) {
