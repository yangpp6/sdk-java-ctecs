 ...
 * Entity: EcsNetworkSpecUpdateReturnObj
 */
public class EcsNetworkSpecUpdateReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public EcsNetworkSpecUpdateReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public EcsNetworkSpecUpdateReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public EcsNetworkSpecUpdateReturnObj withRegionID(String regionID) {
