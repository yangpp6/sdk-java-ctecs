...
/**
 * <一类节点-*-云主机ctecs-创建云主机>
 * Entity: CreateInstanceDataDiskList
 */
public class CreateInstanceDataDiskList {
    /**
     * diskMode
     ...
     * @return this
     */
    public CreateInstanceDataDiskList withDiskMode(String diskMode) {
     ...
     * @return this
     */
    public CreateInstanceDataDiskList withDiskName(String diskName) {
     ...
     * @return this
     */
    public CreateInstanceDataDiskList withDiskType(String diskType) {
     ...
     * @return this
     */
    public CreateInstanceDataDiskList withDiskSize(Integer diskSize) {
