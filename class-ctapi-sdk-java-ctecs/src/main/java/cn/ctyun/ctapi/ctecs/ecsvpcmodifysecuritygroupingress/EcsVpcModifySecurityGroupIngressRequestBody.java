 ...
 * Entity: EcsVpcModifySecurityGroupIngressRequestBody
 */
public class EcsVpcModifySecurityGroupIngressRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupIngressRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupIngressRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupIngressRequestBody withSecurityGroupRuleID(String securityGroupRuleID) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupIngressRequestBody withDescription(String description) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupIngressRequestBody withClientToken(String clientToken) {
