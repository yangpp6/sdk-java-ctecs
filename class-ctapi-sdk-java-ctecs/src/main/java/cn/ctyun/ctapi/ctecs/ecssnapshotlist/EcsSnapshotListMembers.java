 ...
 * Entity: EcsSnapshotListMembers
 */
public class EcsSnapshotListMembers {
    /**
     * volume_type_name
     ...
     * @return this
     */
    public EcsSnapshotListMembers withVolume_type_name(String volume_type_name) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withVolume_id(String volume_id) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withVolume_name(String volume_name) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withIs_bootable(Boolean is_bootable) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withIs_encrypted(Boolean is_encrypted) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withVolume_size(Integer volume_size) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withSnapshot_id(String snapshot_id) {
     ...
     * @return this
     */
    public EcsSnapshotListMembers withSnapshot_status(String snapshot_status) {
