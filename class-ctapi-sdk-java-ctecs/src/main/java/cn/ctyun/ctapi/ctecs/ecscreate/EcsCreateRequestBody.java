 ...
 * Entity: EcsCreateRequestBody
 */
public class EcsCreateRequestBody {
    /**
     * clientToken
    ...
    /**
     * flavorID
     * 云主机规格ID，您可以调用[flavorID](https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8327&data=87)查看最新的天翼云具体资源池的云主机规格列
     */
     ...
     * 数据盘
     */
    private EcsCreateDisks[] diskList;
    /**
     * vpc
     * 虚拟私有云ID
     */
    ...
    /**
     * onDemand
     * 购买方式，取值范围：<br />false：按周期，<br />true：按需，按周期创建云主机需要同时指定cycleCount和cycleType参数
     */
     ...
     * 网卡
     */
    private EcsCreateNetworkCardList[] networkCardList;
    /**
     * extIP
    ...
    /**
     * cycleType
     * 订购周期类型，取值范围：<br />MONTH表示按月，<br />YEAR表示按年，<br />最长订购周期为5年
     */
     ...
     * @return this
     */
    public EcsCreateRequestBody withClientToken(String clientToken) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateRequestBody withProjectID(String projectID) {
    ...
    /**
     * set vmName
     * @param vmName 云主机名称，不可以使用已存在的云主机名称。不同操作系统下，云主机名称规则有差异。<br />Windows：长度为2~15个字符，允许使用大小写字母、数字或连字符（-），不能以连字符（-）开头或结尾，不能连续使用连字符（-），也不能仅使用数字；<br />其他操作系统：长度为2-64字符，允许使用点（.）分隔字符成多段，每段允许使用大小写字母、数字或连字符（-），但不能连续使用点号（.）或连字符（-），不能以点号（.）或连字符（-）开头或结尾，也不能仅使用数字。
     * @return this
     */
    public EcsCreateRequestBody withVmName(String vmName) {
        this.vmName = vmName;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateRequestBody withDisplayName(String displayName) {
    ...
    /**
     * set flavorID
     * @param flavorID 云主机规格ID，您可以调用[flavorID](https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8327&data=87)查看最新的天翼云具体资源池的云主机规格列
     * @return this
     */
    public EcsCreateRequestBody withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withImagePublic(Integer imagePublic) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withImageID(String imageID) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withSyshdType(String syshdType) {
    ...
    /**
     * set syshd
     * @param syshd 系统盘大小单位为GB，取值范围：[40-32768]
     * @return this
     */
    public EcsCreateRequestBody withSyshd(Integer syshd) {
        this.syshd = syshd;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateRequestBody withDiskList(EcsCreateDisks[] diskList) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withVpc(String vpc) {
        this.vpc = vpc;
        return this;
    }
    ...
    /**
     * set onDemand
     * @param onDemand 购买方式，取值范围：<br />false：按周期，<br />true：按需，按周期创建云主机需要同时指定cycleCount和cycleType参数
     * @return this
     */
    public EcsCreateRequestBody withOnDemand(Boolean onDemand) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withSecGroupList(String[] secGroupList) {
    ...
    /**
     * set networkCardList
     * @param networkCardList 网卡
     * @return this
     */
    public EcsCreateRequestBody withNetworkCardList(EcsCreateNetworkCardList[] networkCardList) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withExtIP(String extIP) {
        this.extIP = extIP;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateRequestBody withIpType(String ipType) {
        this.ipType = ipType;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateRequestBody withBandWidth(Integer bandWidth) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withIpv6Address(String ipv6Address) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withPublicIP(String publicIP) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withAffinityGroup(String affinityGroup) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withKeyPairID(String keyPairID) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withRootPassword(String rootPassword) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withCycleCount(Integer cycleCount) {
    ...
    /**
     * set cycleType
     * @param cycleType 订购周期类型，取值范围：<br />MONTH表示按月，<br />YEAR表示按年，<br />最长订购周期为5年
     * @return this
     */
    public EcsCreateRequestBody withCycleType(String cycleType) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withAutoRenewStatus(Integer autoRenewStatus) {
     ...
     * @return this
     */
    public EcsCreateRequestBody withUserData(String userData) {
    ...
    public EcsCreateDisks[] getDiskList() {
        return diskList;
    }

    public void setDiskList(EcsCreateDisks[] diskList) {
        this.diskList = diskList;
    }
    ...
    public EcsCreateNetworkCardList[] getNetworkCardList() {
        return networkCardList;
    }

    public void setNetworkCardList(EcsCreateNetworkCardList[] networkCardList) {
        this.networkCardList = networkCardList;
    }
