 ...
 * Entity: UpgradeRepoReturnObj
 */
public class UpgradeRepoReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public UpgradeRepoReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public UpgradeRepoReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public UpgradeRepoReturnObj withRegionID(String regionID) {
