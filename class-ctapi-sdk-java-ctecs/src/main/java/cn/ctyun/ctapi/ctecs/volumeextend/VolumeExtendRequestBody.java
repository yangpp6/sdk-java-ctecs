...
/**
 * <扩容云硬盘>
 * Entity: VolumeExtendRequestBody
 */
public class VolumeExtendRequestBody {
    /**
     * diskSize
     * 扩容后的磁盘容量，单位为GB，取值范围：数据盘-[10, 32768]；系统盘-[10-2048]
     */
    ...
    /**
     * set diskSize
     * @param diskSize 扩容后的磁盘容量，单位为GB，取值范围：数据盘-[10, 32768]；系统盘-[10-2048]
     * @return this
     */
    public VolumeExtendRequestBody withDiskSize(Integer diskSize) {
     ...
     * @return this
     */
    public VolumeExtendRequestBody withDiskID(String diskID) {
        this.diskID = diskID;
        return this;
    }
     ...
     * @return this
     */
    public VolumeExtendRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public VolumeExtendRequestBody withClientToken(String clientToken) {
