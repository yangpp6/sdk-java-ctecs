 ...
 * Entity: VolumeListRequestBody
 */
public class VolumeListRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public VolumeListRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public VolumeListRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public VolumeListRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public VolumeListRequestBody withPageSize(Integer pageSize) {
