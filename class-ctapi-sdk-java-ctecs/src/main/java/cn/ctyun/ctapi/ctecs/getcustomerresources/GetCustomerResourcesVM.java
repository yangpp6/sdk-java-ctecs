 ...
 * Entity: GetCustomerResourcesVM
 */
public class GetCustomerResourcesVM {
    /**
     * vm_shutd_count
     * 已关机云主机数量
     */
     ...
     * @return this
     */
    public GetCustomerResourcesVM withVm_shutd_count(Integer vm_shutd_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withExpire_count(Integer expire_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withExpire_running_count(Integer expire_running_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withExpire_shutd_count(Integer expire_shutd_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withVm_running_count(Integer vm_running_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withTotal_count(Integer total_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withCpu_count(Integer cpu_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withMemory_count(Integer memory_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVM withDetail_total_count(Integer detail_total_count) {
