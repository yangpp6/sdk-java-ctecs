...
/**
 * <退订轻量型云主机>
 * Entity: EcsLiteUnsubscribeReturnObj
 */
public class EcsLiteUnsubscribeReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public EcsLiteUnsubscribeReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public EcsLiteUnsubscribeReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public EcsLiteUnsubscribeReturnObj withRegionID(String regionID) {
