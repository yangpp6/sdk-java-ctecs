 ...
 * Entity: SnapshotPolicyTaskListRequestBody
 */
public class SnapshotPolicyTaskListRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyTaskListRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyTaskListRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyTaskListRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public SnapshotPolicyTaskListRequestBody withPageSize(Integer pageSize) {
