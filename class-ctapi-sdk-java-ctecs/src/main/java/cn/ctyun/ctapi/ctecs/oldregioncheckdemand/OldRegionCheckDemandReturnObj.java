 ...
 * Entity: OldRegionCheckDemandReturnObj
 */
public class OldRegionCheckDemandReturnObj {
    /**
     * satisfied
     * 是否可售
     */
     ...
     * @return this
     */
    public OldRegionCheckDemandReturnObj withSatisfied(Boolean satisfied) {
     ...
     * @return this
     */
    public OldRegionCheckDemandReturnObj withSellout(Boolean sellout) {
     ...
     * @return this
     */
    public OldRegionCheckDemandReturnObj withHasQuota(Boolean hasQuota) {
     ...
     * @return this
     */
    public OldRegionCheckDemandReturnObj withQuotaInfo(Object quotaInfo) {
     ...
     * @return this
     */
    public OldRegionCheckDemandReturnObj withUsedInfo(Object usedInfo) {
