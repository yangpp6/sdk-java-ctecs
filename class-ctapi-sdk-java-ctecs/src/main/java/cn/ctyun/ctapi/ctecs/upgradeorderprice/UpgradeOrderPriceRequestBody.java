 ...
 * Entity: UpgradeOrderPriceRequestBody
 */
public class UpgradeOrderPriceRequestBody {
    /**
     * regionID
     * 资源池ID
     */
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withResourceID(String resourceID) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withResourceType(String resourceType) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withFlavorName(String flavorName) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withBandwidth(Integer bandwidth) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withDiskSize(Integer diskSize) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withNatType(String natType) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withIpPoolBandwidth(Integer ipPoolBandwidth) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withElbType(String elbType) {
     ...
     * @return this
     */
    public UpgradeOrderPriceRequestBody withCbrValue(Integer cbrValue) {
