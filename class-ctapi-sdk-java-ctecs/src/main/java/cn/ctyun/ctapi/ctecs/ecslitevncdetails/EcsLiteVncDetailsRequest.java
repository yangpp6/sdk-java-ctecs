...
/**
 * <获取轻量型云主机的VNC>
 * Request: EcsLiteVncDetailsRequest
 */
public class EcsLiteVncDetailsRequest extends CTRequest {
    public EcsLiteVncDetailsRequest() {
        super("GET", "application/json", "/v4/ecs/lite/vnc/details");
    }
     ...
     * @return this
     */
    public EcsLiteVncDetailsRequest withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsLiteVncDetailsRequest withInstanceID(String instanceID) {
