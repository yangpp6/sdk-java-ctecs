 ...
 * Request: BackupStatisticsRequest
 */
public class BackupStatisticsRequest extends CTRequest {
    public BackupStatisticsRequest() {
     ...
     * @return this
     */
    public BackupStatisticsRequest withRegionID(String regionID) {
     ...
     * @return this
     */
    public BackupStatisticsRequest withInstanceID(String instanceID) {
