 ...
 * Entity: RebuildInstanceRequestBody
 */
public class RebuildInstanceRequestBody {
    /**
     * regionID
    ...
    /**
     * password
     * 用户密码，满足以下规则：<br />长度在8～30个字符;<br />必须包含大写字母、小写字母、数字以及特殊符号中的三项;<br />特殊符号可选：<br />()\`~!@#$%^&*_-+=\｜{}[]:;'<>,.?/ <br />且不能以斜线号/开头用户密码，满足以下规则：<br />长度在8～30个字符；<br />必须包含大写字母、小写字母、数字以及特殊符号中的三项；<br />特殊符号可选：()`~!@#$%^&*_-+=｜{}[]:;'<>,.?/\且不能以斜线号 / 开头；<br />不能包含3个及以上连续字符；<br />Linux镜像不能包含镜像用户名（root）、用户名的倒序（toor）、用户名大小写变化（如RoOt、rOot等）；<br />Windows镜像不能包含镜像用户名（Administrator）、用户名大小写变化（adminiSTrator等）
     */
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withInstanceID(String instanceID) {
    ...
    /**
     * set password
     * @param password 用户密码，满足以下规则：<br />长度在8～30个字符;<br />必须包含大写字母、小写字母、数字以及特殊符号中的三项;<br />特殊符号可选：<br />()\`~!@#$%^&*_-+=\｜{}[]:;'<>,.?/ <br />且不能以斜线号/开头用户密码，满足以下规则：<br />长度在8～30个字符；<br />必须包含大写字母、小写字母、数字以及特殊符号中的三项；<br />特殊符号可选：()`~!@#$%^&*_-+=｜{}[]:;'<>,.?/\且不能以斜线号 / 开头；<br />不能包含3个及以上连续字符；<br />Linux镜像不能包含镜像用户名（root）、用户名的倒序（toor）、用户名大小写变化（如RoOt、rOot等）；<br />Windows镜像不能包含镜像用户名（Administrator）、用户名大小写变化（adminiSTrator等）
     * @return this
     */
    public RebuildInstanceRequestBody withPassword(String password) {
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withImageID(String imageID) {
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withUserData(String userData) {
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withInstanceName(String instanceName) {
     ...
     * @return this
     */
    public RebuildInstanceRequestBody withMonitorService(Boolean monitorService) {
