...
/**
 * <一类节点-*-云主机ctecs-创建云主机>
 * Entity: CreateInstanceReturnObj
 */
public class CreateInstanceReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public CreateInstanceReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public CreateInstanceReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public CreateInstanceReturnObj withMasterResourceID(String masterResourceID) {
     ...
     * @return this
     */
    public CreateInstanceReturnObj withRegionID(String regionID) {
