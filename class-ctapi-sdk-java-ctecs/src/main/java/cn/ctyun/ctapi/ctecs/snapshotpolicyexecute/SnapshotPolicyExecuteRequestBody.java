 ...
 * Entity: SnapshotPolicyExecuteRequestBody
 */
public class SnapshotPolicyExecuteRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyExecuteRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyExecuteRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
