 ...
 * Entity: EcsBackupRequestBody
 */
public class EcsBackupRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsBackupRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsBackupRequestBody withPolicyID(String policyID) {
