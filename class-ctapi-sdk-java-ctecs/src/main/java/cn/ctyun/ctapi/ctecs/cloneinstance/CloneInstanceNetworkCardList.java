...
/**
 * <一类节点-*-云主机ctecs-克隆云主机>
 * Entity: CloneInstanceNetworkCardList
 */
public class CloneInstanceNetworkCardList {
    /**
     * nicName
     ...
     * @return this
     */
    public CloneInstanceNetworkCardList withNicName(String nicName) {
     ...
     * @return this
     */
    public CloneInstanceNetworkCardList withFixedIP(String fixedIP) {
     ...
     * @return this
     */
    public CloneInstanceNetworkCardList withIsMaster(Boolean isMaster) {
     ...
     * @return this
     */
    public CloneInstanceNetworkCardList withSubnetID(String subnetID) {
