 ...
 * Entity: BatchStopInstanceRequestBody
 */
public class BatchStopInstanceRequestBody {
    ...
    /**
     * force
     * 是否强制关机，取值范围：true（强制关机）、false（普通关机）。<br />注：默认值false。
     */
     ...
     * @return this
     */
    public BatchStopInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BatchStopInstanceRequestBody withInstanceIDList(String instanceIDList) {
    ...
    /**
     * set force
     * @param force 是否强制关机，取值范围：true（强制关机）、false（普通关机）。<br />注：默认值false。
     * @return this
     */
    public BatchStopInstanceRequestBody withForce(Boolean force) {
        this.force = force;
        return this;
    }
