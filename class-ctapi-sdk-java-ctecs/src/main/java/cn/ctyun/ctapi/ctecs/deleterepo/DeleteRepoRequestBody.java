 ...
 * Entity: DeleteRepoRequestBody
 */
public class DeleteRepoRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public DeleteRepoRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public DeleteRepoRequestBody withRepositoryID(String repositoryID) {
     ...
     * @return this
     */
    public DeleteRepoRequestBody withClientToken(String clientToken) {
