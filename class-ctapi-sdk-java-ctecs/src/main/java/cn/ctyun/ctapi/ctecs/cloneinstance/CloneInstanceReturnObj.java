...
/**
 * <一类节点-*-云主机ctecs-克隆云主机>
 * Entity: CloneInstanceReturnObj
 */
public class CloneInstanceReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public CloneInstanceReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public CloneInstanceReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public CloneInstanceReturnObj withMasterResourceID(String masterResourceID) {
     ...
     * @return this
     */
    public CloneInstanceReturnObj withRegionID(String regionID) {
