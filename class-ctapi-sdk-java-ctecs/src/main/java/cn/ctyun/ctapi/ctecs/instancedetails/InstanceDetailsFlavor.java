 ...
 * Entity: InstanceDetailsFlavor
 */
public class InstanceDetailsFlavor {
    /**
     * flavorID
     * 规格ID
     */
     ...
     * @return this
     */
    public InstanceDetailsFlavor withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withFlavorName(String flavorName) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withFlavorCPU(Integer flavorCPU) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withFlavorRAM(Integer flavorRAM) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withGpuType(String gpuType) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withGpuCount(Integer gpuCount) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withGpuVendor(String gpuVendor) {
     ...
     * @return this
     */
    public InstanceDetailsFlavor withVideoMemSize(Integer videoMemSize) {
