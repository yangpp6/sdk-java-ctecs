 ...
 * Entity: SnapshotPolicyDeleteRequestBody
 */
public class SnapshotPolicyDeleteRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyDeleteRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyDeleteRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
