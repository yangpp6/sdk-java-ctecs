...
/**
 * <一类节点-*-云主机ctecs-新订单询价>
 * Entity: OrderNewQueryPriceDisks
 */
public class OrderNewQueryPriceDisks {
    /**
     * diskType
     ...
     * @return this
     */
    public OrderNewQueryPriceDisks withDiskType(String diskType) {
     ...
     * @return this
     */
    public OrderNewQueryPriceDisks withDiskSize(Integer diskSize) {
