 ...
 * Entity: SnapshotPolicyBindInstancesRequestBody
 */
public class SnapshotPolicyBindInstancesRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyBindInstancesRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyBindInstancesRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyBindInstancesRequestBody withInstanceIDs(String instanceIDs) {
