...
/**
 * <一类节点-*-云主机ctecs-续订云主机>
 * Entity: ResubscribeInstanceReturnObj
 */
public class ResubscribeInstanceReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public ResubscribeInstanceReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public ResubscribeInstanceReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public ResubscribeInstanceReturnObj withRegionID(String regionID) {
