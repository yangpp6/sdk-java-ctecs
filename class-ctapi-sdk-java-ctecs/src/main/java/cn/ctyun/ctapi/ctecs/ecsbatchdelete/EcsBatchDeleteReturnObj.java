 ...
 * Entity: EcsBatchDeleteReturnObj
 */
public class EcsBatchDeleteReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public EcsBatchDeleteReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public EcsBatchDeleteReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public EcsBatchDeleteReturnObj withRegionID(String regionID) {
