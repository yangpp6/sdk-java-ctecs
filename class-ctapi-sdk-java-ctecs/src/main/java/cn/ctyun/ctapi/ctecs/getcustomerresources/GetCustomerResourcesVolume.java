 ...
 * Entity: GetCustomerResourcesVolume
 */
public class GetCustomerResourcesVolume {
    /**
     * vo_root_count
     * 系统盘数量
     */
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withVo_root_count(Integer vo_root_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withVo_disk_count(Integer vo_disk_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withTotal_count(Integer total_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withDetail_total_count(Integer detail_total_count) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withTotal_size(Integer total_size) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withVo_disk_size(Integer vo_disk_size) {
     ...
     * @return this
     */
    public GetCustomerResourcesVolume withVo_root_size(Integer vo_root_size) {
