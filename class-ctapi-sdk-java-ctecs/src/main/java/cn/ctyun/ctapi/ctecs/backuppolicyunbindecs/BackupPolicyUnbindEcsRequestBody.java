 ...
 * Entity: BackupPolicyUnbindEcsRequestBody
 */
public class BackupPolicyUnbindEcsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public BackupPolicyUnbindEcsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BackupPolicyUnbindEcsRequestBody withPolicyID(String policyID) {
     ...
     * @return this
     */
    public BackupPolicyUnbindEcsRequestBody withInstanceIDList(String instanceIDList) {
