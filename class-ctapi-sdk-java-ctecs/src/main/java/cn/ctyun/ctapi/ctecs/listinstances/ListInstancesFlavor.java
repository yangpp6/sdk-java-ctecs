 ...
 * Entity: ListInstancesFlavor
 */
public class ListInstancesFlavor {
    /**
     * flavorID
     * 规格ID
     */
     ...
     * @return this
     */
    public ListInstancesFlavor withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public ListInstancesFlavor withFlavorName(String flavorName) {
     ...
     * @return this
     */
    public ListInstancesFlavor withFlavorCPU(Integer flavorCPU) {
     ...
     * @return this
     */
    public ListInstancesFlavor withFlavorRAM(Integer flavorRAM) {
     ...
     * @return this
     */
    public ListInstancesFlavor withGpuType(String gpuType) {
     ...
     * @return this
     */
    public ListInstancesFlavor withGpuCount(Integer gpuCount) {
     ...
     * @return this
     */
    public ListInstancesFlavor withGpuVendor(String gpuVendor) {
     ...
     * @return this
     */
    public ListInstancesFlavor withVideoMemSize(Integer videoMemSize) {
