...
/**
 * <一类节点-*-云主机ctecs-解绑安全组>
 * Entity: EcsVpcLeaveSecurityGroupRequestBody
 */
public class EcsVpcLeaveSecurityGroupRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsVpcLeaveSecurityGroupRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsVpcLeaveSecurityGroupRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @return this
     */
    public EcsVpcLeaveSecurityGroupRequestBody withInstanceID(String instanceID) {
