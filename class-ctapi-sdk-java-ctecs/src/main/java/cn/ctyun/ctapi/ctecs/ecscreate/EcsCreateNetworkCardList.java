 ...
 * Entity: EcsCreateNetworkCardList
 */
public class EcsCreateNetworkCardList {
    /**
     * title
     ...
     * @return this
     */
    public EcsCreateNetworkCardList withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateNetworkCardList withFixedIP(String fixedIP) {
     ...
     * @return this
     */
    public EcsCreateNetworkCardList withMaster(Boolean master) {
        this.master = master;
        return this;
    }
     ...
     * @return this
     */
    public EcsCreateNetworkCardList withSubnetID(String subnetID) {
