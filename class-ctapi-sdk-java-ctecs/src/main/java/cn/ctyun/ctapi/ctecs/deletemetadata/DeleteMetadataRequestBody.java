 ...
 * Entity: DeleteMetadataRequestBody
 */
public class DeleteMetadataRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public DeleteMetadataRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public DeleteMetadataRequestBody withInstanceID(String instanceID) {
