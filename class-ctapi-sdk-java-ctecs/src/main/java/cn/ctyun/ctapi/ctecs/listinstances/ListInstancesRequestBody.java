 ...
 * Entity: ListInstancesRequestBody
 */
public class ListInstancesRequestBody {
     ...
     * 标签信息列表
     */
    private ListInstancesLabelList[] labelList;
     ...
     * @return this
     */
    public ListInstancesRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public ListInstancesRequestBody withProjectID(String projectID) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public ListInstancesRequestBody withState(String state) {
        this.state = state;
        return this;
    }
     ...
     * @return this
     */
    public ListInstancesRequestBody withKeyword(String keyword) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withInstanceName(String instanceName) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withInstanceIDList(String instanceIDList) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withVpcID(String vpcID) {
        this.vpcID = vpcID;
        return this;
    }
     ...
     * @return this
     */
    public ListInstancesRequestBody withResourceID(String resourceID) {
     ...
     * @return this
     */
    public ListInstancesRequestBody withLabelList(ListInstancesLabelList[] labelList) {
    ...
    public ListInstancesLabelList[] getLabelList() {
        return labelList;
    }

    public void setLabelList(ListInstancesLabelList[] labelList) {
        this.labelList = labelList;
    }
}
