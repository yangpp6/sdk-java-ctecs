 ...
 * Entity: SnapshotPolicyCreateReturnObj
 */
public class SnapshotPolicyCreateReturnObj {
    /**
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withSnapshotPolicyStatus(Integer snapshotPolicyStatus) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withSnapshotPolicyName(String snapshotPolicyName) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withRetentionType(String retentionType) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withRetentionDay(String retentionDay) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withRetentionNum(String retentionNum) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withCycleType(String cycleType) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withCycleDay(String cycleDay) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withCycleWeek(String cycleWeek) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateReturnObj withSnapshotTime(String snapshotTime) {
