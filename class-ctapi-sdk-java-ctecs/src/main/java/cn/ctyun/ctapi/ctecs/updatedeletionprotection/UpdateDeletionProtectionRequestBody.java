...
/**
 * <更新云主机实例删除保护信息>
 * Entity: UpdateDeletionProtectionRequestBody
 */
public class UpdateDeletionProtectionRequestBody {
     ...
     * @return this
     */
    public UpdateDeletionProtectionRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UpdateDeletionProtectionRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public UpdateDeletionProtectionRequestBody withDeletionProtection(Boolean deletionProtection) {
     ...
     * @return this
     */
    public UpdateDeletionProtectionRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
