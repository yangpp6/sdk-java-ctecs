...
/**
 * <云主机热变配>
 * Entity: LiveReiszeInstanceReturnObj
 */
public class LiveReiszeInstanceReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public LiveReiszeInstanceReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public LiveReiszeInstanceReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public LiveReiszeInstanceReturnObj withRegionID(String regionID) {
