...
/**
 * <查询轻量型云主机详情>
 * Entity: EcsLiteDetailsRequestBody
 */
public class EcsLiteDetailsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsLiteDetailsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsLiteDetailsRequestBody withInstanceID(String instanceID) {
