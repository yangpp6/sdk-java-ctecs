 ...
 * Entity: EcsDiskHistoryMetricDataResult
 */
public class EcsDiskHistoryMetricDataResult {
    /**
     * fUID
     * 唯一键
     */
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataResult withFUID(String fUID) {
        this.fUID = fUID;
        return this;
    }
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataResult withFuserLastUpdated(String fuserLastUpdated) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataResult withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataResult withDeviceUUID(String deviceUUID) {
