 ...
 * Entity: EcsMemHistoryMetricDataResult
 */
public class EcsMemHistoryMetricDataResult {
    /**
     * fUID
     * 唯一键
     */
     ...
     * @return this
     */
    public EcsMemHistoryMetricDataResult withFUID(String fUID) {
        this.fUID = fUID;
        return this;
    }
     ...
     * @return this
     */
    public EcsMemHistoryMetricDataResult withFuserLastUpdated(String fuserLastUpdated) {
     ...
     * @return this
     */
    public EcsMemHistoryMetricDataResult withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsMemHistoryMetricDataResult withDeviceUUID(String deviceUUID) {
