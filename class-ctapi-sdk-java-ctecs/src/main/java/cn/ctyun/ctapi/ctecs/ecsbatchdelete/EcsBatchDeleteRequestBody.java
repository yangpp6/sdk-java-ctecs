 ...
 * Entity: EcsBatchDeleteRequestBody
 */
public class EcsBatchDeleteRequestBody {
    /**
     * clientToken
     ...
     * @return this
     */
    public EcsBatchDeleteRequestBody withClientToken(String clientToken) {
     ...
     * @return this
     */
    public EcsBatchDeleteRequestBody withRegionID(String regionID) {
    ...
    /**
     * set instanceIDList
     * @param instanceIDList 云主机ID，您可以查看<a href="https://www.ctyun.cn/products/ecs">弹性云主机</a>了解云主机的相关信息<br />获取：<br /><span style="background-color: rgb(73, 204, 144);color: rgb(255,255,255);padding: 2px; margin:2px">查</span> <a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8309&data=87">查询云主机列表</a>
     * @return this
     */
    public EcsBatchDeleteRequestBody withInstanceIDList(String instanceIDList) {
