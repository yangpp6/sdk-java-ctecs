 ...
 * Entity: SnapshotPolicyUnbindInstancesRequestBody
 */
public class SnapshotPolicyUnbindInstancesRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyUnbindInstancesRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyUnbindInstancesRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyUnbindInstancesRequestBody withInstanceIDs(String instanceIDs) {
