 ...
 * Entity: EcsVpcCreateSecurityGroupIngressRequestBody
 */
public class EcsVpcCreateSecurityGroupIngressRequestBody {
    /**
     * regionID
     ...
     */
    private EcsVpcCreateSecurityGroupIngressSecurityGroupRules[] securityGroupRules;
    /**
     * clientToken
     ...
     * @return this
     */
    public EcsVpcCreateSecurityGroupIngressRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsVpcCreateSecurityGroupIngressRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @return this
     */
    public EcsVpcCreateSecurityGroupIngressRequestBody withSecurityGroupRules(EcsVpcCreateSecurityGroupIngressSecurityGroupRules[] securityGroupRules) {
     ...
     * @return this
     */
    public EcsVpcCreateSecurityGroupIngressRequestBody withClientToken(String clientToken) {
    ...
    public EcsVpcCreateSecurityGroupIngressSecurityGroupRules[] getSecurityGroupRules() {
        return securityGroupRules;
    }

    public void setSecurityGroupRules(EcsVpcCreateSecurityGroupIngressSecurityGroupRules[] securityGroupRules) {
        this.securityGroupRules = securityGroupRules;
    }
