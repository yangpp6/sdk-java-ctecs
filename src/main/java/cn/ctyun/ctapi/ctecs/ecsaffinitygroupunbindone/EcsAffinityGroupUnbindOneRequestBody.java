 ...
 * Entity: EcsAffinityGroupUnbindOneRequestBody
 */
public class EcsAffinityGroupUnbindOneRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsAffinityGroupUnbindOneRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsAffinityGroupUnbindOneRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public EcsAffinityGroupUnbindOneRequestBody withID(String ID) {
        this.ID = ID;
        return this;
    }
     ...
     * @return this
     */
    public EcsAffinityGroupUnbindOneRequestBody withAffinityGroupID(String affinityGroupID) {
