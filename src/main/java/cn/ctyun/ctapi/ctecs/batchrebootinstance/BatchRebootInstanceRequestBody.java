 ...
 * Entity: BatchRebootInstanceRequestBody
 */
public class BatchRebootInstanceRequestBody {
     ...
     * @return this
     */
    public BatchRebootInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BatchRebootInstanceRequestBody withInstanceIDList(String instanceIDList) {
