 ...
 * Entity: CreateMetadataRequestBody
 */
public class CreateMetadataRequestBody {
     ...
     * @return this
     */
    public CreateMetadataRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public CreateMetadataRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public CreateMetadataRequestBody withMetadata(Map<String, String> metadata) {
