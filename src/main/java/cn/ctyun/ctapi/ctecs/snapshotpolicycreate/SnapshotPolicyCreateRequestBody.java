 ...
 * Entity: SnapshotPolicyCreateRequestBody
 */
public class SnapshotPolicyCreateRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withSnapshotPolicyName(String snapshotPolicyName) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withSnapshotTime(String snapshotTime) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withCycleType(String cycleType) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withCycleDay(Integer cycleDay) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withCycleWeek(String cycleWeek) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withRetentionType(String retentionType) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withRetentionDay(Integer retentionDay) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withRetentionNum(Integer retentionNum) {
     ...
     * @return this
     */
    public SnapshotPolicyCreateRequestBody withSnapshotPolicyStatus(Integer snapshotPolicyStatus) {
