 ...
 * Entity: ResetPasswordRequestBody
 */
public class ResetPasswordRequestBody {
     ...
     * @return this
     */
    public ResetPasswordRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public ResetPasswordRequestBody withInstanceID(String instanceID) {
