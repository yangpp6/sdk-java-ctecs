 ...
 * Entity: SnapshotStatusRequestBody
 */
public class SnapshotStatusRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotStatusRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotStatusRequestBody withSnapshotID(String snapshotID) {
