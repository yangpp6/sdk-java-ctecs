 ...
 * Entity: DeleteBackupPolicyRequestBody
 */
public class DeleteBackupPolicyRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public DeleteBackupPolicyRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public DeleteBackupPolicyRequestBody withPolicyID(String policyID) {
