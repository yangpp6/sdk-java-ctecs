 ...
 * Entity: EcsMetadataBatchDeleteRequestBody
 */
public class EcsMetadataBatchDeleteRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsMetadataBatchDeleteRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsMetadataBatchDeleteRequestBody withInstanceIDList(String instanceIDList) {
