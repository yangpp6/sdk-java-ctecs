 ...
 * Entity: RebootInstanceRequestBody
 */
public class RebootInstanceRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public RebootInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public RebootInstanceRequestBody withInstanceID(String instanceID) {
