 ...
 * Entity: SnapshotCreateRequestBody
 */
public class SnapshotCreateRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotCreateRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotCreateRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public SnapshotCreateRequestBody withSnapshotName(String snapshotName) {
