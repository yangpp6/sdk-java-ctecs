 ...
 * Entity: SnapshotPolicyEnableRequestBody
 */
public class SnapshotPolicyEnableRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyEnableRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyEnableRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
