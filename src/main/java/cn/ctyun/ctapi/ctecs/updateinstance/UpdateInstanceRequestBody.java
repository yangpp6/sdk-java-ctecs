...
/**
 * <一类节点-*-云主机ctecs-更新云主机>
 * Entity: UpdateInstanceRequestBody
 */
public class UpdateInstanceRequestBody {
     ...
     * @return this
     */
    public UpdateInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UpdateInstanceRequestBody withInstanceID(String instanceID) {
    ...
    /**
     * set displayName
     * @param displayName 云主机显示名称，长度为2~63个字符
     * @return this
     */
    public UpdateInstanceRequestBody withDisplayName(String displayName) {
