 ...
 * Entity: BackupPolicyBindEcsRequestBody
 */
public class BackupPolicyBindEcsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public BackupPolicyBindEcsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BackupPolicyBindEcsRequestBody withPolicyID(String policyID) {
     ...
     * @return this
     */
    public BackupPolicyBindEcsRequestBody withInstanceIDList(String instanceIDList) {
