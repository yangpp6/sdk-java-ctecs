 ...
 * Entity: EcsNetworkHistoryMetricDataRequestBody
 */
public class EcsNetworkHistoryMetricDataRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withDeviceIDList(String[] deviceIDList) {
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withPeriod(Integer period) {
        this.period = period;
        return this;
    }
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withStartTime(String startTime) {
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withEndTime(String endTime) {
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withPage(Integer page) {
        this.page = page;
        return this;
    }
     ...
     * @return this
     */
    public EcsNetworkHistoryMetricDataRequestBody withPageSize(Integer pageSize) {
