 ...
 * Entity: BackupVmDetailsFlavor
 */
public class BackupVmDetailsFlavor {
    /**
     * flavorID
     * 规格ID
     */
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withFlavorName(String flavorName) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withFlavorCPU(Integer flavorCPU) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withFlavorRAM(Integer flavorRAM) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withGpuType(String gpuType) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withGpuCount(Integer gpuCount) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withGpuVendor(String gpuVendor) {
     ...
     * @return this
     */
    public BackupVmDetailsFlavor withVideoMemSize(Integer videoMemSize) {
