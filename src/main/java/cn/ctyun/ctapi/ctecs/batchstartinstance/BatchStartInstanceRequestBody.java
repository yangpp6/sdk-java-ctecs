 ...
 * Entity: BatchStartInstanceRequestBody
 */
public class BatchStartInstanceRequestBody {
     ...
     * @return this
     */
    public BatchStartInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BatchStartInstanceRequestBody withInstanceIDList(String instanceIDList) {
