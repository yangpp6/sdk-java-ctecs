 ...
 * Entity: EcsBatchShelveInstancesRequestBody
 */
public class EcsBatchShelveInstancesRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsBatchShelveInstancesRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsBatchShelveInstancesRequestBody withInstanceIDList(String instanceIDList) {
