 ...
 * Entity: SnapshotPolicyDisableReturnObj
 */
public class SnapshotPolicyDisableReturnObj {
    /**
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withSnapshotPolicyStatus(Integer snapshotPolicyStatus) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withSnapshotPolicyName(String snapshotPolicyName) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withRetentionType(String retentionType) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withRetentionDay(String retentionDay) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withRetentionNum(String retentionNum) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withCycleType(String cycleType) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withCycleDay(String cycleDay) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withCycleWeek(String cycleWeek) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyDisableReturnObj withSnapshotTime(String snapshotTime) {
