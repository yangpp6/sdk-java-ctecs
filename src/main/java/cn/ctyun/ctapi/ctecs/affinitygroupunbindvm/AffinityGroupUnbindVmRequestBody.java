 ...
 * Entity: AffinityGroupUnbindVmRequestBody
 */
public class AffinityGroupUnbindVmRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public AffinityGroupUnbindVmRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public AffinityGroupUnbindVmRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public AffinityGroupUnbindVmRequestBody withAffinityGroupID(String affinityGroupID) {
