 ...
 * Entity: EcsStopRequestBody
 */
public class EcsStopRequestBody {
    /**
     * regionID
     * 资源池ID
     */
     ...
     * @return this
     */
    public EcsStopRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsStopRequestBody withAzName(String azName) {
        this.azName = azName;
        return this;
    }
     ...
     * @return this
     */
    public EcsStopRequestBody withID(String ID) {
        this.ID = ID;
        return this;
    }
