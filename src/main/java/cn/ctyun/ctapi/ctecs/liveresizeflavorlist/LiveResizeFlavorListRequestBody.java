...
/**
 * <查询云主机支持的热变配规格信息>
 * Entity: LiveResizeFlavorListRequestBody
 */
public class LiveResizeFlavorListRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public LiveResizeFlavorListRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public LiveResizeFlavorListRequestBody withInstanceID(String instanceID) {
