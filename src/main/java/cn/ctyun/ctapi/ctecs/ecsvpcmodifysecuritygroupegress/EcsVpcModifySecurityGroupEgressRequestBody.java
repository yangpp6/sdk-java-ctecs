 ...
 * Entity: EcsVpcModifySecurityGroupEgressRequestBody
 */
public class EcsVpcModifySecurityGroupEgressRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupEgressRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupEgressRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @param securityGroupRuleID 安全组出向规则ID，获取：<br /><span style="background-color: rgb(73, 204, 144);color: rgb(255,255,255);padding: 2px; margin:2px">查</span> <a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=18&api=4818&data=94">查询用户安全组详情</a><br /><span style="background-color: rgb(97, 175, 254);color: rgb(255,255,255);padding: 2px; margin:2px">创</span> <a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=18&api=4824&data=94">创建安全组出向规则</a><br />注：在多可用区类型资源池下，安全组ID通常以“sg-”开头，非多可用区类型资源池安全组ID为uuid格式
     * @return this
     */
    public EcsVpcModifySecurityGroupEgressRequestBody withSecurityGroupRuleID(String securityGroupRuleID) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupEgressRequestBody withDescription(String description) {
     ...
     * @return this
     */
    public EcsVpcModifySecurityGroupEgressRequestBody withClientToken(String clientToken) {
