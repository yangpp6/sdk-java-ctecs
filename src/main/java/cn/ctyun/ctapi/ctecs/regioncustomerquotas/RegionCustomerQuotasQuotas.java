 ...
 * Entity: RegionCustomerQuotasQuotas
 */
public class RegionCustomerQuotasQuotas {
    /**
     ...
     * @return this
     */
    public RegionCustomerQuotasQuotas withMax_count_of_nic_per_vm(Integer max_count_of_nic_per_vm) {
     ...
     * @return this
     */
    public RegionCustomerQuotasQuotas withSecurity_groups_limit(Integer security_groups_limit) {
     ...
     * @return this
     */
    public RegionCustomerQuotasQuotas withNic_relate_security_group_limit(Integer nic_relate_security_group_limit) {
     ...
     * @return this
     */
    public RegionCustomerQuotasQuotas withSecurity_group_rules_limit(Integer security_group_rules_limit) {
