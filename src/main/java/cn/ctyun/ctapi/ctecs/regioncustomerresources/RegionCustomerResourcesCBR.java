 ...
 * Entity: RegionCustomerResourcesCBR
 */
public class RegionCustomerResourcesCBR {
    /**
     * total_count
     * 云主机备份总数
     */
     ...
     * @return this
     */
    public RegionCustomerResourcesCBR withTotal_count(Integer total_count) {
     ...
     * @return this
     */
    public RegionCustomerResourcesCBR withDetail_total_count(Integer detail_total_count) {
     ...
     * @return this
     */
    public RegionCustomerResourcesCBR withTotal_size(Integer total_size) {
     ...
     * @return this
     */
    public RegionCustomerResourcesCBR withDetail(Object detail) {
        this.detail = detail;
        return this;
    }
