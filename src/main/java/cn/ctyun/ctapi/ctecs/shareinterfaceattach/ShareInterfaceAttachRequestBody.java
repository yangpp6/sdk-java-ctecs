 ...
 * Entity: ShareInterfaceAttachRequestBody
 */
public class ShareInterfaceAttachRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public ShareInterfaceAttachRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public ShareInterfaceAttachRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public ShareInterfaceAttachRequestBody withSubnetID(String subnetID) {
