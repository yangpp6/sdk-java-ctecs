 ...
 * Entity: CreateRepoReturnObj
 */
public class CreateRepoReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public CreateRepoReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public CreateRepoReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public CreateRepoReturnObj withRegionID(String regionID) {
     ...
     * @param masterResourceID 订单主资源ID
     * @return this
     */
    public CreateRepoReturnObj withMasterResourceID(String masterResourceID) {
