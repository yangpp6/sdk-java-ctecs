 ...
 * Entity: EcsBackupCreateReturnObj
 */
public class EcsBackupCreateReturnObj {
    /**
     * volumeCount
     * 云硬盘数目
     */
     ...
     * 云主机关联云硬盘映射表
     */
    private EcsBackupCreateBlockDeviceMappingS[] block_device_mappings;
    /**
     * createAt
     * 创建时间
     */
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withVolumeCount(Integer volumeCount) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withRestoreFinishTime(String restoreFinishTime) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withInstanceBackupID(String instanceBackupID) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withRepoFreezing(Boolean repoFreezing) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withSize(Integer size) {
        this.size = size;
        return this;
    }
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withRepositoryID(String repositoryID) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withRepositoryName(String repositoryName) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withDeleted(Boolean deleted) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withUsedSize(Integer usedSize) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withStatus(String status) {
        this.status = status;
        return this;
    }
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withDescription(String description) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withInstanceName(String instanceName) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withRepoExpired(Boolean repoExpired) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withInstanceBackupName(String instanceBackupName) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withBlock_device_mappings(EcsBackupCreateBlockDeviceMappingS[] block_device_mappings) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withCreateAt(String createAt) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withUpdateAt(String updateAt) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withFinishTime(String finishTime) {
     ...
     * @return this
     */
    public EcsBackupCreateReturnObj withProjectID(String projectID) {
    ...
    public EcsBackupCreateBlockDeviceMappingS[] getBlock_device_mappings() {
        return block_device_mappings;
    }

    public void setBlock_device_mappings(EcsBackupCreateBlockDeviceMappingS[] block_device_mappings) {
        this.block_device_mappings = block_device_mappings;
    }
