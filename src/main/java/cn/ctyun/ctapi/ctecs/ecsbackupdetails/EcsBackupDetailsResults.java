 ...
 * Entity: EcsBackupDetailsResults
 */
public class EcsBackupDetailsResults {
    /**
     * volumeCount
     * 云硬盘数目
     */
     ...
     * 云主机关联云硬盘映射表
     */
    private EcsBackupDetailsBlockDeviceMappingS[] block_device_mappings;
    /**
     * createAt
     * 创建时间
     */
     ...
     * @return this
     */
    public EcsBackupDetailsResults withVolumeCount(Integer volumeCount) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withRestoreFinishTime(String restoreFinishTime) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withInstanceBackupID(String instanceBackupID) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withRepoFreezing(Boolean repoFreezing) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withSize(Integer size) {
        this.size = size;
        return this;
    }
     ...
     * @return this
     */
    public EcsBackupDetailsResults withRepositoryID(String repositoryID) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withRepositoryName(String repositoryName) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withDeleted(Boolean deleted) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withUsedSize(Integer usedSize) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withStatus(String status) {
        this.status = status;
        return this;
    }
     ...
     * @return this
     */
    public EcsBackupDetailsResults withDescription(String description) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withInstanceName(String instanceName) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withRepoExpired(Boolean repoExpired) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withInstanceBackupName(String instanceBackupName) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withBlock_device_mappings(EcsBackupDetailsBlockDeviceMappingS[] block_device_mappings) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withCreateAt(String createAt) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withUpdateAt(String updateAt) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withFinishTime(String finishTime) {
     ...
     * @return this
     */
    public EcsBackupDetailsResults withProjectID(String projectID) {
    ...
    public EcsBackupDetailsBlockDeviceMappingS[] getBlock_device_mappings() {
        return block_device_mappings;
    }

    public void setBlock_device_mappings(EcsBackupDetailsBlockDeviceMappingS[] block_device_mappings) {
        this.block_device_mappings = block_device_mappings;
    }
