 ...
 * Entity: BackupPolicyBindRepoRequestBody
 */
public class BackupPolicyBindRepoRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public BackupPolicyBindRepoRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public BackupPolicyBindRepoRequestBody withRepositoryID(String repositoryID) {
     ...
     * @return this
     */
    public BackupPolicyBindRepoRequestBody withPolicyID(String policyID) {
