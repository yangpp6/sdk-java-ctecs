 ...
 * Entity: SnapshotPolicyUpdateReturnObj
 */
public class SnapshotPolicyUpdateReturnObj {
    /**
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withSnapshotPolicyStatus(Integer snapshotPolicyStatus) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withSnapshotPolicyName(String snapshotPolicyName) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withRetentionType(String retentionType) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withRetentionDay(String retentionDay) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withRetentionNum(String retentionNum) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withCycleType(String cycleType) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withCycleDay(String cycleDay) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withCycleWeek(String cycleWeek) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyUpdateReturnObj withSnapshotTime(String snapshotTime) {
