 ...
 * Entity: EcsDiskHistoryMetricDataRequestBody
 */
public class EcsDiskHistoryMetricDataRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withDeviceIDList(String[] deviceIDList) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withPeriod(Integer period) {
        this.period = period;
        return this;
    }
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withStartTime(String startTime) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withEndTime(String endTime) {
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withPage(Integer page) {
        this.page = page;
        return this;
    }
     ...
     * @return this
     */
    public EcsDiskHistoryMetricDataRequestBody withPageSize(Integer pageSize) {
