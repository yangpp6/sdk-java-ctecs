 ...
 * Entity: DeleteRepoReturnObj
 */
public class DeleteRepoReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public DeleteRepoReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public DeleteRepoReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public DeleteRepoReturnObj withRegionID(String regionID) {
