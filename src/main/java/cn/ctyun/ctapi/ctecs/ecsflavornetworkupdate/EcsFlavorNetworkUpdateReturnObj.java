 ...
 * Entity: EcsFlavorNetworkUpdateReturnObj
 */
public class EcsFlavorNetworkUpdateReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public EcsFlavorNetworkUpdateReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public EcsFlavorNetworkUpdateReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public EcsFlavorNetworkUpdateReturnObj withRegionID(String regionID) {
