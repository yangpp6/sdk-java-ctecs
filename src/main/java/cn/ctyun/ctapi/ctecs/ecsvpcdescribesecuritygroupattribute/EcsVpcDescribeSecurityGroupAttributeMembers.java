 ...
 * Entity: EcsVpcDescribeSecurityGroupAttributeMembers
 */
public class EcsVpcDescribeSecurityGroupAttributeMembers {
    /**
     * diskType
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskType(String diskType) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskID(String diskID) {
        this.diskID = diskID;
        return this;
    }
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskName(String diskName) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withIsBootable(Boolean isBootable) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withIsEncrypt(Boolean isEncrypt) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskSize(Integer diskSize) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskSnapshotID(String diskSnapshotID) {
     ...
     * @return this
     */
    public EcsVpcDescribeSecurityGroupAttributeMembers withDiskSnapshotStatus(String diskSnapshotStatus) {
