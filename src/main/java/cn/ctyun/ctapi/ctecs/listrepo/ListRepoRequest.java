 ...
 */
public class ListRepoRequest extends CTRequest {
    public ListRepoRequest() {
     ...
     * @return this
     */
    public ListRepoRequest withRegionID(String regionID) {
     ...
     * @return this
     */
    public ListRepoRequest withProjectID(String projectID) {
        queryParam.put("projectID", projectID);
        return this;
    }

    /**
     * <Query param> set repositoryName
     * @param repositoryName 云主机备份存储库名称，满足以下规则：只能由数字、字母、-组成，不能以数字和-开头、且不能以-结尾，长度为2-63字符
     * @return this
     */
    public ListRepoRequest withRepositoryName(String repositoryName) {
        queryParam.put("repositoryName", repositoryName);
        return this;
    }

    /**
     * <Query param> set repositoryID
     ...
     * @return this
     */
    public ListRepoRequest withRepositoryID(String repositoryID) {
        queryParam.put("repositoryID", repositoryID);
        return this;
    }
     ...
     * @return this
     */
    public ListRepoRequest withStatus(String status) {
     ...
     * @return this
     */
    public ListRepoRequest withPageNo(Integer pageNo) {
     ...
     * @param pageSize 每页记录数目，取值范围：[1~50]，默认值：10，单页最大记录不超过50
     * @return this
     */
    public ListRepoRequest withPageSize(Integer pageSize) {
