 ...
 * Entity: EcsVpcRevokeSecurityGgroupEgressRequestBody
 */
public class EcsVpcRevokeSecurityGgroupEgressRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsVpcRevokeSecurityGgroupEgressRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsVpcRevokeSecurityGgroupEgressRequestBody withSecurityGroupID(String securityGroupID) {
     ...
     * @return this
     */
    public EcsVpcRevokeSecurityGgroupEgressRequestBody withSecurityGroupRuleID(String securityGroupRuleID) {
     ...
     * @return this
     */
    public EcsVpcRevokeSecurityGgroupEgressRequestBody withClientToken(String clientToken) {
