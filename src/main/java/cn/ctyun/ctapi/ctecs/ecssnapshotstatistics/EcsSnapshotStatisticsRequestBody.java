...
/**
 * <云主机快照个数统计>
 * Entity: EcsSnapshotStatisticsRequestBody
 */
public class EcsSnapshotStatisticsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsSnapshotStatisticsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsSnapshotStatisticsRequestBody withInstanceIDList(String instanceIDList) {
