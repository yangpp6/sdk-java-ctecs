 ...
 * Entity: UpdateInstanceSpecRequestBody
 */
public class UpdateInstanceSpecRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public UpdateInstanceSpecRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UpdateInstanceSpecRequestBody withInstanceID(String instanceID) {
    ...
    /**
     * set bandwidth
     * @param bandwidth 带宽大小单位为Mbit/s，取值范围:[1~2000]。带宽与规格参数必须2选1，不支持同时传入带宽与规格
     * @return this
     */
    public UpdateInstanceSpecRequestBody withBandwidth(Integer bandwidth) {
     ...
     * @return this
     */
    public UpdateInstanceSpecRequestBody withFlavorID(String flavorID) {
     ...
     * @return this
     */
    public UpdateInstanceSpecRequestBody withClientToken(String clientToken) {
