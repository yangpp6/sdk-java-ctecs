 ...
 * Entity: SnapshotPolicyDetailsRequestBody
 */
public class SnapshotPolicyDetailsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public SnapshotPolicyDetailsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsRequestBody withSnapshotPolicyID(String snapshotPolicyID) {
