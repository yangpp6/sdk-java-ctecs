 ...
 * Entity: SnapshotPolicyDetailsReturnObj
 */
public class SnapshotPolicyDetailsReturnObj {
    /**
     * snapshotPolicyID
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withSnapshotPolicyID(String snapshotPolicyID) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withSnapshotPolicyStatus(Integer snapshotPolicyStatus) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withSnapshotPolicyName(String snapshotPolicyName) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withSnapshotTime(String snapshotTime) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withRetentionType(String retentionType) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withRetentionDay(String retentionDay) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withRetentionNum(String retentionNum) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withCycleType(String cycleType) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withCycleDay(Integer cycleDay) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withCycleWeek(String cycleWeek) {
     ...
     * @return this
     */
    public SnapshotPolicyDetailsReturnObj withResourceCount(Integer resourceCount) {
