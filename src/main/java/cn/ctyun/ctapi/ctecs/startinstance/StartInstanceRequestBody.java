 ...
 * Entity: StartInstanceRequestBody
 */
public class StartInstanceRequestBody {
     ...
     * @return this
     */
    public StartInstanceRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public StartInstanceRequestBody withInstanceID(String instanceID) {
