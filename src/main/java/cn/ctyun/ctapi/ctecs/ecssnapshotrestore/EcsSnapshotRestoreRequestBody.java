 ...
 * Entity: EcsSnapshotRestoreRequestBody
 */
public class EcsSnapshotRestoreRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public EcsSnapshotRestoreRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsSnapshotRestoreRequestBody withSnapshotID(String snapshotID) {
