...
/**
 * <退订轻量型云主机>
 * Entity: EcsLiteUnsubscribeRequestBody
 */
public class EcsLiteUnsubscribeRequestBody {
    /**
     * clientToken
     ...
     * @return this
     */
    public EcsLiteUnsubscribeRequestBody withClientToken(String clientToken) {
     ...
     * @return this
     */
    public EcsLiteUnsubscribeRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsLiteUnsubscribeRequestBody withInstanceID(String instanceID) {
