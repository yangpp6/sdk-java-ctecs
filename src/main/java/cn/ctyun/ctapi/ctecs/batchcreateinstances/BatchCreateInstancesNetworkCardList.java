 ...
 * Entity: BatchCreateInstancesNetworkCardList
 */
public class BatchCreateInstancesNetworkCardList {
    /**
     * nicName
    ...
    /**
     * fixedIP
     * 内网IPv4地址，<br />注：不可使用已占用IP；当购买数量超过1时（orderCount>1），该参数不可使用
     */
     ...
     * @return this
     */
    public BatchCreateInstancesNetworkCardList withNicName(String nicName) {
    ...
    /**
     * set fixedIP
     * @param fixedIP 内网IPv4地址，<br />注：不可使用已占用IP；当购买数量超过1时（orderCount>1），该参数不可使用
     * @return this
     */
    public BatchCreateInstancesNetworkCardList withFixedIP(String fixedIP) {
     ...
     * @return this
     */
    public BatchCreateInstancesNetworkCardList withIsMaster(Boolean isMaster) {
     ...
     * @return this
     */
    public BatchCreateInstancesNetworkCardList withSubnetID(String subnetID) {
