 ...
 * Entity: UserdataDetailsRequestBody
 */
public class UserdataDetailsRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public UserdataDetailsRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UserdataDetailsRequestBody withInstanceID(String instanceID) {
