 ...
 * Entity: EcsCpuHistoryMetricDataResult
 */
public class EcsCpuHistoryMetricDataResult {
    /**
     * fUID
     * 唯一键
     */
     ...
     * @return this
     */
    public EcsCpuHistoryMetricDataResult withFUID(String fUID) {
        this.fUID = fUID;
        return this;
    }
     ...
     * @return this
     */
    public EcsCpuHistoryMetricDataResult withFuserLastUpdated(String fuserLastUpdated) {
     ...
     * @return this
     */
    public EcsCpuHistoryMetricDataResult withRegionID(String regionID) {
     ...
     * @return this
     */
    public EcsCpuHistoryMetricDataResult withDeviceUUID(String deviceUUID) {
