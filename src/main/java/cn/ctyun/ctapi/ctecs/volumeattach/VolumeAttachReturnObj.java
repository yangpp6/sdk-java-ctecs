...
/**
 * <挂载云硬盘>
 * Entity: VolumeAttachReturnObj
 */
public class VolumeAttachReturnObj {
    /**
     * diskJobID
     ...
     * @return this
     */
    public VolumeAttachReturnObj withDiskJobID(String diskJobID) {
     ...
     * @return this
     */
    public VolumeAttachReturnObj withDiskRequestID(String diskRequestID) {
