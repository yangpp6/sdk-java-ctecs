 ...
 * Entity: EcsBackupListBlockDeviceMappingS
 */
public class EcsBackupListBlockDeviceMappingS {
    /**
     * backup_id
     * 云硬盘备份ID
     */
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withBackup_id(String backup_id) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withVolume_id(String volume_id) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withBoot_volume(Boolean boot_volume) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withMount_device(String mount_device) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withVolume_size(String volume_size) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withVolume_type(String volume_type) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withDelete_on_termination(Boolean delete_on_termination) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withBoot_index(Integer boot_index) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withDevice_name(String device_name) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withContainer(String container) {
     ...
     * @return this
     */
    public EcsBackupListBlockDeviceMappingS withService_metadata(String service_metadata) {
