 ...
 * Entity: UpdateNetworkSpecReturnObj
 */
public class UpdateNetworkSpecReturnObj {
    /**
     * masterOrderID
     ...
     * @return this
     */
    public UpdateNetworkSpecReturnObj withMasterOrderID(String masterOrderID) {
     ...
     * @return this
     */
    public UpdateNetworkSpecReturnObj withMasterOrderNO(String masterOrderNO) {
     ...
     * @return this
     */
    public UpdateNetworkSpecReturnObj withRegionID(String regionID) {
