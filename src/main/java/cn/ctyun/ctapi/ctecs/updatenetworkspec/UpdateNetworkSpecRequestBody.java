 ...
 * Entity: UpdateNetworkSpecRequestBody
 */
public class UpdateNetworkSpecRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public UpdateNetworkSpecRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public UpdateNetworkSpecRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public UpdateNetworkSpecRequestBody withBandwidth(Integer bandwidth) {
     ...
     * @return this
     */
    public UpdateNetworkSpecRequestBody withClientToken(String clientToken) {
