 ...
 * Entity: AffinityGroupBindVmRequestBody
 */
public class AffinityGroupBindVmRequestBody {
    /**
     * regionID
     ...
     * @return this
     */
    public AffinityGroupBindVmRequestBody withRegionID(String regionID) {
     ...
     * @return this
     */
    public AffinityGroupBindVmRequestBody withInstanceID(String instanceID) {
     ...
     * @return this
     */
    public AffinityGroupBindVmRequestBody withAffinityGroupID(String affinityGroupID) {
